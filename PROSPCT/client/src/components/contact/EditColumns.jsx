...
export default function EditColumns() {
  ...
  useEffect(() => {
    if (isContactEditColumnsVisible) {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        setContactEditColumnsVisible(false);
      }
    };
      ...
      >
        <div className="flex justify-between items-center p-4 px-7 bg-blue-600 text-white rounded-t-lg">
          ...
          <X
            ...
            onClick={() => setContactEditColumnsVisible(false)}
          />
        </div>
          ...
          <div className="w-1/2 border-r border-gray-300 pr-4">
            <div className="relative mb-4">
              <input
                ...
                // NOTE: Search input is not wired up yet; it's UI-only.
              />
            </div>
