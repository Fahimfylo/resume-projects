...
export default function AdminAiCenter() {
  ...
  if (!data) return <div className="min-h-screen bg-nexus-void flex items-center justify-center"><div className="text-nexus-jade font-headline text-sm animate-pulse">LOADING AI TELEMETRY...</div></div>;
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-nexus-jade tracking-[0.5em] mb-2 uppercase">AI Command</div>
