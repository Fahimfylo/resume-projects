...
import {
  Trash2, MessageSquare, FileText, UserX, ShieldAlert, CheckCircle, XCircle,
  ArrowUpCircle, Eye,
} from 'lucide-react';
...
export default function AdminModeration() {
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-nexus-jade tracking-[0.5em] mb-2 uppercase">Content Control</div>
        <h1 className="text-3xl lg:text-5xl font-headline font-black text-white tracking-tighter uppercase">
          CONTENT <span className="text-nexus-gold">MODERATION</span>
        </h1>
      </div>
      ...
      <Tabs defaultValue="posts" className="space-y-6">
        <TabsList className="bg-nexus-carbon/60 border border-white/10 p-1 rounded-none">
          <TabsTrigger value="posts" className="font-ui text-xs data-[state=active]:bg-nexus-jade data-[state=active]:text-nexus-void rounded-none">
            <FileText className="w-3.5 h-3.5 mr-2" /> Posts
          </TabsTrigger>
          <TabsTrigger value="comments" className="font-ui text-xs data-[state=active]:bg-nexus-teal data-[state=active]:text-nexus-void rounded-none">
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className="text-xs font-headline text-nexus-jade">{post.userId?.gamerTag || 'UNKNOWN'}</span>
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-headline text-nexus-teal">{comment.gamerTag || 'UNKNOWN'}</span>
