...
export default function AdminReports() {
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-nexus-jade tracking-[0.5em] mb-2 uppercase">Reports Center</div>
            ...
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                ...
                <div className="text-xs text-white/60 font-ui mt-1">
                  Reported by <span className="text-nexus-jade">{report.reporter?.gamerTag || 'System'}</span>
                  {report.targetUser && (
