...
export default function GuardianAnalytics() {
  ...
  if (!data) return <div className="min-h-screen bg-nexus-void flex items-center justify-center"><div className="text-[#ffd700] font-headline text-sm animate-pulse">CALCULATING GUARDIAN METRICS...</div></div>;
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-[#ffd700] tracking-[0.5em] mb-2 uppercase">Guardian Metrics Lab</div>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card className="glass-panel p-6 rounded-none hud-frame bg-nexus-carbon/40 border-white/10">
          <h3 className="text-xs font-ui text-[#ffd700] tracking-[0.3em] mb-6 uppercase flex items-center gap-2">
          ...
          <div className="h-[260px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={topGamesData}>
                ...
                <YAxis tick={{ fill: '#ffffff40', fontSize: 10 }} axisLine={false} tickLine={false} />
                <Tooltip contentStyle={{ background: '#0f1115', border: '1px solid #ffd70020', borderRadius: 0, fontSize: 12 }} labelStyle={{ color: '#ffd700' }} />
