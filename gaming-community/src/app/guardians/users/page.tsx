...
export default function GuardianUsers() {
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-[#ffd700] tracking-[0.5em] mb-2 uppercase">Guardian User Management</div>
            ...
            {users.map((u, i) => (
              ...
              >
                <td className="py-3 px-4">
                  <Link href={`/guardians/users?id=${u._id}`} className="font-headline text-white hover:text-[#ffd700] transition-colors">
                    {u.gamerTag || 'UNNAMED'}
                  </Link>
                ...
                <td className="py-3 px-4 text-right">
                  <div className="flex items-center justify-end gap-1">
                    ...
                    {u.isBanned && (
                      <Button size="icon" variant="ghost" className="w-7 h-7 text-white/40 hover:text-[#ffd700]" onClick={() => handleUnban(u._id)}>
