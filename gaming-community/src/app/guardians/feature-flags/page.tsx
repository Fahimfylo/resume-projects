...
export default function GuardianFeatureFlags() {
  ...
  useEffect(() => {
    ...
    if (!can('system.settings')) { router.push('/guardians/dashboard'); return; }
    fetchFlags();
  }, [user, loading, router, fetchFlags, can]);
  ...
  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="text-[10px] font-ui text-[#ffd700] tracking-[0.5em] mb-2 uppercase">Guardian System Config</div>
        ...
        {flags.map((flag, i) => (
          ...
          >
            <div className="flex items-center gap-4">
              <Switch checked={flag.enabled} onCheckedChange={() => handleToggle(flag._id, flag.enabled)} className="data-[state=checked]:bg-[#ffd700]" />
              <div>
            ...
            <div className={`text-[10px] font-ui uppercase tracking-widest ${flag.enabled ? 'text-[#ffd700]' : 'text-white/30'}`}>
