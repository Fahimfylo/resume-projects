...
export default function GuardianLogs() {
  ...
  useEffect(() => {
    ...
    fetchLogs();
  }, [user, loading, router, fetchLogs, can]);

  return (
    <div className="p-6 lg:p-10 pt-20 lg:pt-10">
      <div className="mb-8">
        <div className="text-[10px] font-ui text-[#ffd700] tracking-[0.5em] mb-2 uppercase">Guardian Audit Trail</div>
            ...
            {logs.map((log, i) => (
              ...
              >
                ...
                <td className="py-3 px-4">
                  <span className="font-headline text-xs" style={{ color: '#ffd700' }}>{log.admin?.gamerTag || 'System'}</span>
                </td>
                <td className="py-3 px-4">
